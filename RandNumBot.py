...
BOT_TOKEN: str = '6254325692:AAGw-A1YpP_r2AsTv6wrovptV7LAx0yulvk'
jokes = ['Программист звонит в библиотеку.''\n'
'— Здравствуйте, Катю можно?''\n'
'— Она в архиве.''\n'
'— Разархивируйте ее пожалуйста. Она мне срочно нужна!', '— Настоящий программист всегда должен ложиться спать или в 1:28 или в 2:56... Ну, на крайний случай, в 5:12.''\n'
...
async def process_start_command(message: Message):
    await message.answer(f'Привет{message.from_user.first_name}, {message.from_user.username}!\nДавай сыграем в игру "Угадай число"?\n\n'
...
async def process_joke_command(message: Message):
    if not user['in_game']:
        await message.answer(jokes[random.randint(0,len(jokes)-1)])
